public class HeronsFormula{
    ...
    public static void main(String[]args){
        ...
        System.out.println(tws+"9,9,9 has area " + g);//this would have been
        //hard without functions.
...
}//Function version is shorter. Six times as much work to fix a+b+C/2.0 in the
//non fucntion version.
